...
import com.furahitechstudio.ustadsample.manager.BluetoothManagerSharedAndroidImpl;
...
public class MainActivity extends AppCompatActivity {
  ...
  private BluetoothManagerSharedAndroidImpl bluetoothImpl;
  @Override
  protected void onCreate(Bundle savedInstanceState) {
    ...
    bluetoothImpl = new BluetoothManagerSharedAndroidImpl(this);
